...
public class SeparatedHandwriting {

    protected static int MaxWidth = 3000;
    protected static int MaxHeight = 4000;
    protected static int MaxnRects = 2000;

    protected static int threshold = 200;
    protected static int MinimumPoints = 50;
    protected static int radius = 5;
    protected static int IntersectPercent = 60;
